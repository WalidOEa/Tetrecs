...
public class Grid {
  ...
  /**
   * Determines whether a piece can be played by extracting the surrounding 3x3 matrix makeup of the
   * x and y positions, adding it to the matrix makeup of the piece and comparing the new matrix to
   * the piece value. For any block not representing the value of gamePiece: if the value has
   * changed compared to the original makeup, return false.
   *
  ...
  /**
   * Places the piece into the grid and updates surrounding values with value of gamePiece,
   * according to its makeup.
   *
   * @param x         x position of block clicked
   * @param y         y position of block clicked
