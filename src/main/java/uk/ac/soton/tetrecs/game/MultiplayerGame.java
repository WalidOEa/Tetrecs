...
import uk.ac.soton.tetrecs.event.NextPieceListener;
import uk.ac.soton.tetrecs.event.GameLoopListener;
import uk.ac.soton.tetrecs.event.LineClearedListener;
import uk.ac.soton.tetrecs.event.CurrentPieceListener;
...
import static uk.ac.soton.tetrecs.game.GamePiece.createPiece;

/**
 * The MultiplayerGame class is responsible for handling logic pertaining to the multiplayer. Unlike
 * Game, MultiplayerGame communicates to web socket server to generate new pieces, update scores,
 * lives, messages and board statuses.
 */
public class MultiplayerGame extends Game {
  ...
  /**
   * Communicator sends message requesting pieces. Returns value and the values are used to generate
   * pieces. The pieces are then stored in a queue.
   */
  ...
  /**
   * Schedules initialRunnable to generate pieces to pieceBoard, executes only once. After runnable
   * is scheduled after the given delay.
   */
  @Override
