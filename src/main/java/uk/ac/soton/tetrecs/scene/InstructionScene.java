...
/**
 * The instruction scene provides instructions on playing the game. These included the rules and
 * controls. Furthermore, a visual representation of each block is generated randomly both in type
 * and rotation.
 */
public class InstructionScene extends BaseScene {
  ...
  public void build() {
    ...
    var instructions = new ImageView(
