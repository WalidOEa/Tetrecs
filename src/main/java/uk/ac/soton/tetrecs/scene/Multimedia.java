...
/**
 * Multimedia is responsible for playing sound effects during specific interactions with the UI as
 * well as playing music during scenes on a loop and playing music through the music player.
 */
public class Multimedia {
  ...
  /**
   * Handles music that plays during runtime. MediaPlayer are declared as field variables to prevent
  ...
  public static void playSound(String filename) {
    ...
    String playSound = Objects.requireNonNull(Multimedia.class.getResource("/sounds/" + filename))
        .toExternalForm();
  ...
  public static void playBackgroundMusic(String filename) {
    ...
    String playMusic = Objects.requireNonNull(Multimedia.class.getResource("/music/" + filename))
        .toExternalForm();
