...
import uk.ac.soton.tetrecs.event.BlockClickedListener;
import uk.ac.soton.tetrecs.event.RightClickedListener;
import uk.ac.soton.tetrecs.game.Grid;
...
public class GameBoard extends GridPane {
  ...
  protected GameBlock createBlock(int x, int y) {
    ...
    block.setOnMouseExited((MouseEvent event) -> {
      if (grid.get(getBlock(getAimX(), getAimY()).getX(), getBlock(getAimX(), getAimY()).getY())
          == 0) {
