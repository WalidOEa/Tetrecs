package uk.ac.soton.tetrecs.component;
...
/**
 * Custom UI component that lays out text containing name and score vertically. Used in displaying
 * scores against other competing players.
 */
public class LeaderBoard extends ScoresList {
  ...
  /**
   * During an event firing, clear all existing nodes in the component and reconstruct it using
   * based off the observable list.
   *
   ...
   */
  public void build(ObservableList<Pair<String, Integer>> scores, String userName,
      String userScore) {
